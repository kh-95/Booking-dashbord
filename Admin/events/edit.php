...
if(!validate($name,1)){
...
}elseif(!validate($name,9)){
    $errors['Name'] = "Length Must >= 14 CH";
  }
    ...
    if(count($errors) > 0){
       ...
       $sql = "update events set name = '$name' , date = '$date' , airline_id = $airline  where id = $id ";
       $op  = mysqli_query($con,$sql);
       ...
       $_SESSION['Message'] = $message;
        ...
        header("Location: http://localhost/week2/AdminLTE-3.0.5/Admin/events/index.php");
        ...
        <div class="container-fluid">
            ...
            <div class="container">
                ...
                <div class="form-group">
                        ...
                        <input type="text" name="name" class="form-control" value = "<?php echo $data['name'] ;?>"  id="exampleInputName"  >
                    </div>
